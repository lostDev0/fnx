...
inline std::string to_string( const sound_evt& evt )
{
    switch ( evt._type )
    {
        ...
        case sound_evt::type::volume:
            return std::string( "volume " ) + std::to_string( evt._left_volume ) + std::string( " " ) + std::to_string(
                       evt._right_volume );
        case sound_evt::type::master_volume:
            return std::string( "master volume " ) + std::to_string( evt._left_volume ) + std::string( " " ) + std::to_string(
                       evt._right_volume );
...
{
    return std::string( "window initialized " ) + std::to_string( evt._width ) + std::string( " " ) + std::to_string(
               evt._height );
}

struct keyboard_press_evt
{
    FNX_KEY _key{ FNX_KEY::FK_UNKNOWN };
};
...
struct mouse_move_evt
{
    fnx::decimal _x{ 0.0 };
    fnx::decimal _y{ 0.0 };
    fnx::decimal _gl_x{ 0.0 };
    fnx::decimal _gl_y{ 0.0 };
};
...
struct mouse_press_evt
{
    FNX_BUTTON _btn{ FNX_BUTTON::BT_UNKNOWN };
    fnx::decimal _x{ 0.0 };
    fnx::decimal _y{ 0.0 };
    fnx::decimal _gl_x{ 0.0 };
    fnx::decimal _gl_y{ 0.0 };
...
struct render_evt
{
    ...
    action_t _action{ action_t::start };
    fnx::decimal _fps_now{ 0.0 };
    fnx::decimal _fps_avg{ 0.0 };
    fnx::decimal _fps_min{ 0.0 };
    fnx::decimal _fps_max{ 0.0 };
};
