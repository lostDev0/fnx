...
public:
    ...
    void render_as_lines()
    {
        _render_as_lines = true;
    }
    ...
    void load_to_attribute( VBO_Index vbo_idx, Attribute_Index attr_idx, unsigned int num_components,
    ...
    void load_to_attribute( Attribute_Index attr_idx, unsigned int num_components, unsigned int stride_in_num_components,
                            unsigned int offset_in_num_components );
    ...
    auto has_raw_model() const
    {
        return _raw_model != nullptr;
    }
    const auto& get_raw_model() const
    {
        return _raw_model;
    }
