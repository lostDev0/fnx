...
public:
    ...
    const auto& get_indices() const
    {
        return _ibo_data;
    }
    const auto& get_material_map() const
    {
        return _material_map;
    }
    const auto& get_aabb() const
    {
        return _aabb;
    }
    auto& get_mutable_vertices()
    {
        return _vbo_data;
    }
    auto& get_mutable_indices()
    {
        return _ibo_data;
    }
    auto& get_mutable_material_map()
    {
        return _material_map;
    }
    auto& get_mutable_aabb()
    {
        return _aabb;
    }
    ...
    {
        return _flags & data_bit::texture;
    }
    bool has_normal_data() const
    {
        return _flags & data_bit::normal;
    }
    bool has_color_data() const
    {
        return _flags & data_bit::color;
    }
    bool is_line() const
    {
        return _flags & data_bit::line;
    }
    bool has_material_map() const
    {
        return _material_map.size();
    }

    void set_texture_data_true()
    {
        _flags |= data_bit::texture;
    }
    void set_normal_data_true()
    {
        _flags |= data_bit::normal;
    }
    void set_color_data_true()
    {
        _flags |= data_bit::color;
    }
    void set_is_line_true()
    {
        _flags |= data_bit::line;
    }

    void set_texture_data_false()
    {
        _flags &= ~( 1 << data_bit::texture );
    }
    void set_normal_data_false()
    {
        _flags &= ~( 1 << data_bit::normal );
    }
    void set_color_data_false()
    {
        _flags &= ~( 1 << data_bit::color );
    }
    void set_is_line_false()
    {
        _flags &= ~( 1 << data_bit::line );
    }
