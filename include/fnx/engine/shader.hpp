...
public:
    ...
    void apply_uniform( const char* uniform_name, const char* member_name, unsigned int index, int x, int y, int z,
                        int w ) const;
    void apply_uniform( const char* uniform_name, const char* member_name, unsigned int index,
