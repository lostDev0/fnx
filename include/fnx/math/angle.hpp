...
struct angle
{
    ...
    /// @return degree value
    auto get_as_degree() const
    {
        return _rad_val * RAD_TO_DEG;
    }

    angle operator+( const angle& other ) const
    {
        return angle( Radian( _rad_val + other._rad_val ) );
    }
    angle operator-( const angle& other ) const
    {
        return angle( Radian( _rad_val - other._rad_val ) );
    ...
    angle operator+( const Radian& rad ) const
    {
        return angle( Radian( _rad_val + rad._rad ) );
    }
    angle operator-( const Radian& rad ) const
    {
        return angle( Radian( _rad_val - rad._rad ) );
    ...
    angle operator+( const Degree& deg ) const
    {
        return angle( Radian( _rad_val + deg._deg * DEG_TO_RAD ) );
    }
    angle operator-( const Degree& deg ) const
    {
        return angle( Radian( _rad_val - deg._deg * DEG_TO_RAD ) );
    ...
    angle& operator+=( const Radian& other )
    {
        *this = *this + other;
        return *this;
    }
    ...
    angle& operator+=( const Degree& other )
    {
        *this = *this + other;
        return *this;
    }
