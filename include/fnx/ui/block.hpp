...
public:
    ...
    {
        _outline_thickness[static_cast<size_t>( state::normal )] = px;
    }
    void set_outline_thickness_hover( const float& px )
    {
        _outline_thickness[static_cast<size_t>( state::hover )] = px;
    }
    void set_outline_thickness_pressed( const float& px )
    {
        _outline_thickness[static_cast<size_t>( state::press )] = px;
    }
    void set_outline_thickness_checked( const float& px )
    {
        _outline_thickness[static_cast<size_t>( state::checked )] = px;
    }

    float get_outline_thickness_normal() const
    {
        return _outline_thickness[static_cast<size_t>( state::normal )];
    }
    float get_outline_thickness_hover() const
    {
        return _outline_thickness[static_cast<size_t>( state::hover )];
    }
    float get_outline_thickness_pressed() const
    {
        return _outline_thickness[static_cast<size_t>( state::press )];
    }
    float get_outline_thickness_checked() const
    {
        return _outline_thickness[static_cast<size_t>( state::checked )];
    }

    void set_outline_color_normal( const unsigned int& color )
    {
        _outline_colors[static_cast<size_t>( state::normal )] = convert_to_color( color );
    }
    void set_outline_color_hover( const unsigned int& color )
    {
        _outline_colors[static_cast<size_t>( state::hover )] = convert_to_color( color );
    }
    void set_outline_color_pressed( const unsigned int& color )
    {
        _outline_colors[static_cast<size_t>( state::press )] = convert_to_color( color );
    }
    void set_outline_color_checked( const unsigned int& color )
    {
        _outline_colors[static_cast<size_t>( state::checked )] = convert_to_color( color );
    }

    unsigned int get_outline_color_normal() const
    {
        return convert_from_color( _outline_colors[static_cast<size_t>( state::normal )] );
    }
    unsigned int get_outline_color_hover() const
    {
        return convert_from_color( _outline_colors[static_cast<size_t>( state::hover )] );
    }
    unsigned int get_outline_color_pressed() const
    {
        return convert_from_color( _outline_colors[static_cast<size_t>( state::press )] );
    }
    unsigned int get_outline_color_checked() const
    {
        return convert_from_color( _outline_colors[static_cast<size_t>( state::checked )] );
    }
