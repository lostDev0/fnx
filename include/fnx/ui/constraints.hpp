...
namespace fnx
{
	...
	public:
		...
		virtual fnx::vector4 apply(const fnx::vector4& parent, const fnx::vector4& child) { return child; }
	...
	protected:
		...
		std::vector<std::unique_ptr<fnx::constraint>> _post_process_constraints;	/// additional constraints that are applied after the base constraints
	};
