...
namespace fnx
{
	...
	public:
		...
		image(const std::string& resource_name, const fnx::colors::rgba& color, const std::string& name = create_type_name<fnx::block>())
			: block(color, name)
			, _resource(resource_name)
		{
		...
		image(const std::string& resource_name, const fnx::texture::config& resource_config, 
			int normal_state_atlas_index, int highlight_state_atlas_index, int press_state_atlas_index, int checked_state_atlas_index, const std::string& name = create_type_name<fnx::block>())
			: block(fnx::colors::black, name)
			, _resource(resource_name)
