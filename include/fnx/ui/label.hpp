...
namespace fnx
{
	...
	public:
		...
		virtual void on_parent_change(reactphysics3d::decimal parent_x, reactphysics3d::decimal parent_y, reactphysics3d::decimal parent_width, reactphysics3d::decimal parent_height) override;
		...
		const auto& get_label() { return _label; }
		...
		void set_text_alignment(alignment align) { _text_alignment = align; }

		/// @brief Add bold styling to the label.
		void set_bold() { _bold = true; }
	...
	protected:
		...
		std::vector<std::pair<reactphysics3d::decimal, std::string>> _lines;	/// each line of the _label broken to fit (width,string)
