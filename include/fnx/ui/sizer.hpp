...
namespace fnx
{
	...
	public:
		...
		vert_sizer(size_t rows=0, vert_sizer::direction direction=vert_sizer::direction::top_to_bottom, const std::string& name = create_type_name<fnx::widget>()) 
	...
	{
	public:
		vert_fit_sizer(size_t rows=0, vert_sizer::direction direction=vert_sizer::direction::top_to_bottom, const std::string& name = create_type_name<fnx::vert_fit_sizer>())
	...
	public:
		...
		horz_sizer(size_t cols=0, horz_sizer::direction direction=horz_sizer::direction::left_to_right, const std::string& name = create_type_name<fnx::horz_sizer>())
	...
	{
	public:
		horz_fit_sizer(size_t cols, horz_sizer::direction direction, const std::string& name = create_type_name<fnx::horz_fit_sizer>())
