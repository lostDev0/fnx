namespace fnx
{
		...
		: _layers()
	{
		...
		events.subscribe<fnx::window_close_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::window_close_evt>));
		events.subscribe<fnx::window_resize_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::window_resize_evt>));
		events.subscribe<fnx::window_move_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::window_move_evt>));
		events.subscribe<fnx::window_minimize_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::window_minimize_evt>));
		events.subscribe<fnx::window_maximize_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::window_maximize_evt>));
		events.subscribe<fnx::window_fullscreen_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::window_fullscreen_evt>));
		events.subscribe<fnx::window_lose_focus_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::window_lose_focus_evt>));
		events.subscribe<fnx::window_gain_focus_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::window_gain_focus_evt>));
		events.subscribe<fnx::keyboard_press_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::keyboard_press_evt>));
		events.subscribe<fnx::keyboard_release_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::keyboard_release_evt>));
		events.subscribe<fnx::keyboard_repeat_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::keyboard_repeat_evt>));
		...
		events.subscribe<fnx::mouse_release_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::mouse_release_evt>));
		events.subscribe<fnx::mouse_scroll_evt>(fnx::bind(*this, &layer_stack::send_event_to_layers<fnx::mouse_scroll_evt>));
